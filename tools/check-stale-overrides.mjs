...
//
// A non-zero exit from `npm audit` means advisories, which is a result rather
// than a failure. Anything else (a resolution error, npm missing) is rethrown,
// so a broken check can never read as a clean one.
